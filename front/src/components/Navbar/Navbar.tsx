          ...
          <div className="flex items-center space-x-4">
            ...
            {isLoggedIn ? (
              <button
                ...
                className="flex items-center p-2 bg-amber-500 text-white rounded-full hover:bg-sky-500 focus:ring-2 focus:ring-amber-500 transition"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div className="flex space-x-2">
                <Link
                  href="/login"
                  className="flex items-center space-x-2 p-2 bg-amber-500 text-white rounded-full hover:bg-sky-500 focus:ring-2 focus:ring-amber-500 transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
