        ...
        <div className="shadow-lg rounded-lg overflow-hidden flex flex-col max-w-md mx-auto">
            ...
            <div className="p-4 md:p-6">
                <div className="flex justify-between items-start mb-4 text-emerald-900">
                    <h3 className="font-bold text-xl md:text-2xl">{rental.brand} {rental.model}</h3>
                    <span
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-gray-700">
                            {format(rental.dateStart, 'dd/MM/yyyy')} - {format(rental.dateEnd, 'dd/MM/yyyy')}
                        </span>
                    </div>
                    <div className="flex items-center">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-bold text-sky-500">${rental.total}</span>
                    </div>
                </div>
            </div>
        </div>
