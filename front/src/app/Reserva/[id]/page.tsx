<<<<<<< HEAD:front/src/app/Reserva/page.tsx
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            <input type="checkbox git " id="saveDetails" className="h-5 w-5" />
  ...
  return (
    <div className="bg-gray-100 p-6 min-h-screen">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="flex items-center mb-6">
          <img
            src={car?.image} // Imagen del coche (sustituir por la imagen real del coche seleccionado)
            alt="Auto seleccionado"
            className="w-1/3 h-auto rounded-lg shadow-lg"
          />
          <div className="ml-6">
            <h3 className="text-2xl font-semibold text-emerald-900">{car?.year} {car?.brand} {car?.model}</h3>
            <p className="text-gray-600">{car?.transmission} | {car?.brakes} | {car?.kilometer} | ${car?.pricePerDay}</p>
...
export default Reserva;
>>>>>>> df3806a4c780a82e448dc44ba54e857792fe112b:front/src/app/Reserva/[id]/page.tsx
